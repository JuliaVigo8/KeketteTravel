            ...
            if (_data == null)
            {
                _data = new List<CountryItemViewModel>()
                {
                    new CountryItemViewModel()
                    {
                        ...
                        TopLeftPosition = new Position(-9614436.104, 1273194.645),
                        BottomRightPosition = new Position(-9148475.981, 870830.117),
                        Activities = new System.Collections.Generic.List<Activity>()
                        {
                            new Activity()
                            {
                                ...
                                Position = new Position(-9363401.858, 1054005.587),
                            ...
                            new Activity()
                            {
                                ...
                                Position = new Position(-9328561.195, 1071028.749),
                    ...
                    { 
                        ...
                        TopLeftPosition = new Position(-16.764936, -77.911225),
                        BottomRightPosition = new Position(-56.293587, -65.167086)
                    },
                };

    ...
    public class HomeViewModel : MvxViewModel
    {
        public override void Start()
        {
            ...
            Countries = new ObservableCollection<CountryItemViewModel>()
            {
                ...
                new CountryItemViewModel() { Id = Guid.NewGuid().ToString(), Name = "Chili", ImageUrl="http://www.guidevoyages.org/wordpress/wp-content/uploads/2013/10/Parque-Nacional-Lauca-y-Volc%C3%A1n-Parinacota-Chile.-Autor-mtchm.-Licensed-under-the-Creative-Commons-Attribution-Share-Alike.jpg" },
            };
        }
